...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.01, nms=dict(type='nms', iou_thr=0.5), max_per_img=300)
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file= data_root + 'CrowdHuman/ImageSets/Main/trainval.txt',
...
log_level = 'INFO'
work_dir = root_dir+'mmdet_models/work_dirs/faster_rcnn_mdconv_c3-c5_x50_fpn_1x'
load_from = None#root_dir+'pretrained/faster-x50-mdconv-epoch35.pth'
resume_from = None #root_dir+'mmdet_models/work_dirs/faster_rcnn_mdconv_c3-c5_x50_fpn_1x/epoch_10.pth'
workflow = [('train', 1)]
